--effects
core.register_chatcommand("hobble", {
	params = "<person>",
	privs = {secret=true},
...
core.register_chatcommand("slowmo", {
	params = "<person> <speed>",
	privs = {secret = true},
	...
	func = function(name, param)
		...
		local target = core.get_player_by_name(split[1])
...
core.register_chatcommand("freeze", {
	params = "<person>",
	privs = {secret=true},
...
core.register_chatcommand("getlost", {
	params = "<person>",
	privs = {secret=true},
...
core.register_chatcommand("blind", {
	params = "<person>",
	privs = {secret=true},
...
-- utility
core.register_chatcommand("proclaim", {
	params = "<text>",
...
core.register_chatcommand("curses",{
	params = "<person>",
	privs = {secret = true},
